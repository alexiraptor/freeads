            ...
            <header>
                ...
                <div class="w-full text-gray-700 bg-gray-800 dark-mode:text-gray-200 dark-mode:bg-gray-800">
                    ...
                    <div class="p-4 flex flex-row items-center justify-between">
                        <a href="{{ route('home') }}" class="text-lg font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Imm<i class="far fa-compass"></i>Land</a>
            ...
            <main>
                ...
                <div class="vp">
                    <div class="vp-content">
                        <h1>L'immobilier sans frontière</h1>
                    </div>
                </div>
            </main>
        </div>
